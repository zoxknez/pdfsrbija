...
public class EndpointConfiguration {
    ...
    public void init() {
        ...
        enableEndpoint("srb/ipsqr");
        enableEndpoint("srb/model97");
        enableEndpoint("srb/iban");
        enableEndpoint("srb/translit");
        enableEndpoint("srb/sef");
        enableEndpoint("srb/pdfa3");
        enableEndpoint("srb/admin");
        enableEndpoint("srb/ocr-prescription");
    }
